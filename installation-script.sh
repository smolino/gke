...
#  Sergio Molino
#
#  This script install Entando application on GKE
#
namespace=$1
appname=$2
...
### Ingress GKE
kubectl apply -f kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/master/deploy/static/provider/cloud/deploy.yaml
...
kubectl apply -f namespace-resource-new-ingress.yaml -n $namespace
echo "##################################################################################"
echo "##################################################################################"
echo ""
